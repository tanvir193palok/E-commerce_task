...
const Offer = () => {
  return (
    <div className="w-[360px] lg:w-[1280px] h-[633px] lg:h-[450px] bg-[#EEECFB] px-4 lg:mx-28 my-2 flex flex-col lg:flex-row justify-center items-center lg:justify-between lg:px-[75px]">
      {/* Text */}
