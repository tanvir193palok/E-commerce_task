...
const Offer = () => {
  return (
    <div className="w-[340px] lg:w-[1280px] h-auto lg:h-[450px] bg-[#EEECFB] flex flex-col lg:flex-row justify-center items-center lg:justify-between mx-4 lg:px-[75px] py-4 lg:py-0">
      {/* Text Section */}
